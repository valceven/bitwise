"use client";
import NavLogo from "../assets/nav-bar-logo.svg";
...
const Header = () => {
  ...
  return (
    <header
      className={`z-50 fixed top-0 left-0 w-full transition-transform duration-300 ${
    ...
    >
      ...
      >
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <Link to="/login"
            className="text-sm/6 font-semibold text-white bg-bluez px-5 py-2 btn-shadow addgrotesk"
          >
